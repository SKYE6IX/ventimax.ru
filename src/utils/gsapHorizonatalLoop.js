...
/**
 * @returns {any}
 * Added this return type to avoid TypeScript errors.
 * The actual return type is a GSAP timeline, but it can vary based on the configuration.
 * This function creates a horizontal looping timeline for a set of items.
 */
      ...
      if (config.draggable && typeof Draggable === "function") {
         ...
         draggable = Draggable.create(proxy, {
            ...
            snap(value) {
               ...
               // the velocity could be very large, throwing off the snap.
               // So sense that condition and adjust for it. We also need to set
               // overshootTolerance to 0 to prevent the inertia from causing it to shoot past and come back.
